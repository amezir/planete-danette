...
const Navbar = () => {
    ...
    return (
        <nav className={styles.navbar}>
            <Link href='/' className={styles.logo}>🌎 Danette</Link>
            ...
            <div>
                {
                    loggedIn ? (
                        <>
                            {
                                router.pathname === '/game' && <Link className='primary' href='/user/me'>Mon profil</Link>
                            }
                            {
                                router.pathname !== '/game' && <Link className='primary' href='/login'>Jouer maintenant</Link>
                            }
